    ...
    <div className="product">
      ...
      <div className="product__info">
        ...
        <p className="info__description">
          ...
          excepturi laudantium? Molestias tempore rem eveniet sunt, quia iure
          suscipit quisquam? Quam illum cumque unde ipsam nesciunt aliquam
          excepturi veniam vitae.
        </p>
